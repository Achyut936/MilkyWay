...
export class ProductsComponent {
  ...
  saveForLater(product: any) {
    ...
    if (saveForLaterData === null) {
      ...
      const existingProduct = saveForLaterArray.find(
        (p) => p.productId === product.productId
      );
      if (!existingProduct) {
        saveForLaterArray.push(product);
  ...
  productArr = [
    {
      img: 'assets/images/milkcart.jpg',
      price: 70,
      product: 'Milk',
      qnt: 1,
      cat: 'milk',
    ...
    {
      img: 'assets/images/coconutMilk.avif',
      price: 400,
    ...
    {
      img: 'assets/images/fullCream.avif',
      price: 50,
    ...
    {
      img: 'assets/images/soyaMilk.avif',
      price: 135,
      product: 'Soya Milk',
      qnt: 1,
      cat: 'milk',
    ...
    {
      img: 'assets/images/srikhand.avif',
      price: 65,
      product: 'Curd',
      qnt: 1,
      cat: 'curd',
    ...
    {
      img: 'assets/images/curpP.avif',
      price: 55,
      product: 'Blue Berry Yougurt',
      qnt: 1,
      cat: 'curd',
      productId: 6,
    },
    {
      img: 'assets/images/mishtiDoi.avif',
      price: 70,
      product: 'Mishti Doi',
      qnt: 1,
      cat: 'curd',
    ...
    {
      img: 'assets/images/mangoCurd.avif',
      price: 65,
      product: 'Mango Yougurt',
      qnt: 1,
      cat: 'curd',
      productId: 8,
    },
    {
      img: 'assets/images/breadP.avif',
      price: 52,
      product: 'Brown Bread',
      qnt: 1,
      cat: 'bread',
    ...
    {
      img: 'assets/images/multigrainBread.avif',
      price: 75,
    ...
    {
      img: 'assets/images/burgerBun.avif',
      price: 45,
      product: 'Burger Bun',
      qnt: 1,
      cat: 'bread',
